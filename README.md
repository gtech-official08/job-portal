...
This is just a starter template containing Navbar, Footer, and Layout. And also installed the required resources like react icons, framer motion, and other basic requirements.
...
```bash
  git clone https://github.com/gtech-official08/job-portal
```
...
### Full Video Tutorial
Video Link:- https://youtu.be/UdoQ54ARpxs
